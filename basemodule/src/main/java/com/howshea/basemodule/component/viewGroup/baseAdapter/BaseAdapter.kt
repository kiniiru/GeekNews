 ...
 * on 2018/9/10
 */
abstract class BaseAdapter<T, out B : ViewDataBinding>(private var items: MutableList<T>, private var layoutRes: Int) : RecyclerView.Adapter<BaseAdapter<T, B>.ViewHolder>() {
	...
	abstract fun bindItem(binding: @UnsafeVariance B, item: T)

	open fun bindAfterExecute(binding: @UnsafeVariance B, item: T) {}
